  ...
  var methods = {
    ...
    init : function(options) {
      ...
      return this.each(function() {
        ...
        var fillScreen = $(this).attr('data-fillScreen') || options.fillScreen;
        ...
        var setOrigDimensions = function() {
          ...
          origObjectRect = $object[0].getBoundingClientRect();
        ...
        origin.off('click.galleryExpand').on('click.galleryExpand', function(e) {
          ...
          // Card vars
          var coverHeight = origin.find('.gallery-cover').height();
          ...
          var recalculateVars = function() {
            ...
            contentOffsetTop = Math.round((coverHeight / 2) + contentPadding + navOffset);

            // Card vars
            headerOffsetTop = (coverHeight / 2) - contentPadding;
